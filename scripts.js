...
const book1 = new Book('Title 1', 'Author 1', 432, true);
const book2 = new Book('Title 2', 'Author 2', 15, false);
const book3 = new Book('Title 3', 'Author 3', 112, true);
const book4 = new Book('Title 4', 'Author 4', 133, true);
library.push(book1);
library.push(book2);
library.push(book3);
library.push(book4);
...
//         <td>${book.pages}</td>
//         if (${book.isRead === true})
//         <td><button class=status-button">${book.isRead}</button></td>
